...
- Runnable SNES / Super Famicom development machine using the shared W65C816 with LoROM/HiROM cartridge mapping, 128 KiB WRAM, CPU/PPU I/O, controllers, vblank/NMI timing, VRAM/CGRAM/OAM register paths, Mode 0/1 BG1 rendering, SRAM persistence, and deterministic save states. SPC700/S-DSP audio, DMA/HDMA, complete PPU modes/sprites and enhancement chips remain foundation work.
