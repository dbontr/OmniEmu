...
SNES / Super Famicom now provides the first W65C816 machine graph. OmniCore maps LoROM/HiROM cartridges and SRAM across the 24-bit bus, models 128 KiB WRAM and CPU/PPU I/O, serial controllers, vblank/NMI, VRAM/CGRAM/OAM register paths and Mode 0/1 BG1 tile rendering. General DMA now transfers through the eight channel registers and B-bus patterns; SPC700/S-DSP, HDMA/timing, the remaining PPU modes/sprites/windows/color math and enhancement chips are intentionally still foundation work.
