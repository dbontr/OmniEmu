...
export const PLATFORMS: Platform[] = [
  ...
  p({ id: 'atari2600', omniCode: 10, name: 'Atari 2600', generation: 2, vendor: 'Atari', years: '1977–1992', extensions: ['a26', 'bin'], tier: 'foundation', note: '6502-family CPU substrate is implemented in OmniCore; TIA/RIOT and cartridge hardware are next.' }),
  p({ id: 'atari5200', omniCode: 11, name: 'Atari 5200', generation: 2, vendor: 'Atari', years: '1982–1984', extensions: ['a52', 'bin'], tier: 'foundation' }),
  p({ id: 'coleco', omniCode: 12, name: 'ColecoVision', generation: 2, vendor: 'Coleco', years: '1982–1985', extensions: ['col', 'rom', 'bin'], tier: 'planned', bios: 'required' }),
  ...
  p({ id: 'nes', omniCode: 20, name: 'NES / Famicom', generation: 3, vendor: 'Nintendo', years: '1983–2003', extensions: ['nes', 'fds', 'unf', 'unif'], tier: 'foundation', launchable: true, note: 'Launchable development graph: shared 6502 CPU, NES bus/controllers/DMA, PPU/NMI/background/sprites, and mapper 0/2/3. APU, additional mappers and timing validation remain before playable status.' }),
  p({ id: 'segaMS', omniCode: 21, name: 'Sega Master System', generation: 3, vendor: 'Sega', years: '1985–1996', extensions: ['sms'], tier: 'planned', bios: 'optional' }),
  p({ id: 'atari7800', omniCode: 22, name: 'Atari 7800', generation: 3, vendor: 'Atari', years: '1986–1992', extensions: ['a78', 'bin'], tier: 'foundation' }),
  p({ id: 'snes', omniCode: 30, name: 'SNES / Super Famicom', generation: 4, vendor: 'Nintendo', years: '1990–2003', extensions: ['sfc', 'smc', 'fig', 'swc'], tier: 'planned', bios: 'optional' }),
  p({ id: 'segaMD', omniCode: 31, name: 'Genesis / Mega Drive', generation: 4, vendor: 'Sega', years: '1988–1997', extensions: ['md', 'gen', 'smd', 'bin'], tier: 'planned' }),
