...
export const PLATFORMS: Platform[] = [
  ...
  p({ id: 'dreamcast', name: 'Dreamcast', generation: 6, vendor: 'Sega', years: '1998–2001', extensions: ['gdi', 'cdi', 'chd'], tier: 'planned', bios: 'optional', note: 'Reserved for a browser-safe Dreamcast core.' }),
  p({ id: 'ps2', name: 'PlayStation 2', generation: 6, vendor: 'Sony', years: '2000–2013', extensions: ['iso', 'chd'], tier: 'planned', bios: 'required', note: 'Requires a production-quality browser PCSX2-class core.' }),
